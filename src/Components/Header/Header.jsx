    ...
    <div className="min-h-[70vh] bg-slate-900">
      <div className="main-container">
        <div className="h-full py-3 items-center flex flex-col justify-center text-white gap-4">
          <h1 className="text-3xl sm:text-4xl lg:text-[55px] font-semibold">
            Learning to code got simplified
          </h1>
          <p className="text-base md:text-xl py-1 md:py-4">
            Learning the latest technology with interactive, hands-on courses.
